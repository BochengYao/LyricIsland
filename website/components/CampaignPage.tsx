  ...
  en: [
    {
      ...
      image: "/images/campaign/hero.png",
      imageAlt: "Lyric Island at the top of a Windows desktop",
      watermark: "BE SEEN",
      variant: "hero"
    },
    {
      ...
      image: "/images/campaign/mouse.png",
      imageAlt: "Lyric Island softening around the pointer",
      watermark: "MAKE ROOM",
      variant: "mouse"
    },
    {
      ...
      subtitle: "Stretch into a clean horizontal layout or fold away to save space. Lyric Island follows the shape you choose.",
      image: "/images/campaign/modular.png",
      imageAlt: "Several modular Lyric Island layouts",
      watermark: "YOUR SHAPE",
      variant: "modules"
    },
    {
      ...
      image: "/images/campaign/collapse.png",
      imageAlt: "Lyric Island retracted above the screen",
      watermark: "ON CUE",
      variant: "collapse"
    },
    {
    ...
    },
    {
      ...
      subtitle: "The Lyric Island you know, connected to the music apps you use.",
      image: "/images/campaign/players.png",
...
const playersByLocale: Record<Locale, string[]> = {
  ...
  en: ["Apple Music", "QQ Music", "NetEase", "KuGou", "Spotify", "KuWo"]
};
