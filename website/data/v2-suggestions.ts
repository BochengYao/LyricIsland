...
const base = [
  ...
  },
  {
    ...
    zh: ["直接拖动真实LyricHover", "从模块工具箱拖到真实LyricHover，支持 18 px 吸附、重排、保存与取消。"],
  ...
  },
  {
    ...
    zh: ["歌词源自动补位", "可选择首选歌词源；匹配不理想时，LyricHover会临时尝试其他已支持来源。"],
  ...
  },
  {
    ...
    zh: ["局部鼠标避让", "只有鼠标附近的LyricHover区域降低透明度，探测范围、光晕与频谱都可以调整。"],
