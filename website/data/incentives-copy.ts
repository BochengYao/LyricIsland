...
const rawIncentivesByLocale: Record<"zh" | "en", IncentivesCopy> = {
  ...
  en: {
    ...
    feature: {
      ...
      reward: "Accepted ideas receive a ¥1 red-packet reward",
...
export const incentivesByLocale: Record<Locale, IncentivesCopy> = {
  ...
  zhHant: {
    ...
    feature: { ...rawIncentivesByLocale.zh.feature, eyebrow: "新功能提議", title: "把你的想法，\n說具體一點。", body: "告訴我們你會在什麼情境使用、目前哪裡不夠順手，以及你期待它如何運作。資訊越具體，越有助於我們評估與實現。", reward: "建議正式採納後，贈送 1 元紅包", acceptedTitle: "已經被聽見…", acceptedSubtitle: "為你認為可行的方案按讚，開發者會優先處理。", acceptedEmpty: "第一批被採納的建議將在這裡滾動出現。" },
  ...
  ja: {
    ...
    feature: { eyebrow: "機能の提案", title: "アイデアを、\nもっと具体的に。", body: "使いたい場面、今の不便さ、期待する動きを教えてください。具体的なほど、評価と実装につながります。", reward: "採用された提案には ¥1 相当の特典", acceptedTitle: "もう、届いています…", acceptedSubtitle: "実現してほしい案に「いいね」を。開発者が優先して確認します。", acceptedEmpty: "最初に採用されたアイデアは、ここに流れてきます。" },
