...
namespace LyricHover.Core
{
    ...
    {
        public const string DirectoryName = "LyricHover";
        private const string PreviousDirectoryName = "LyricsIsland";
        ...
        public static string Prepare(string localApplicationDataRoot)
        {
            ...
            var previousBrandRoot = Path.Combine(localApplicationDataRoot, PreviousDirectoryName);
            ...
            try
            {
                if (Directory.Exists(previousBrandRoot) && !Directory.Exists(currentRoot))
                {
                    Directory.Move(previousBrandRoot, currentRoot);
                    return currentRoot;
                }
                ...
                CopyMissingFilesBestEffort(previousBrandRoot, currentRoot);
